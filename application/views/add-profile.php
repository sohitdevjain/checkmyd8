                    ...
                    <div class="col-8 offset-md-2">
                        <div class="profile-message text-center">
                            ...
                            <div class="sec-w-form">
                                <form name="step-2-profile" method="post" action="<?php echo site_url('add-user-profile');?>" class="step-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 has-input-bl">
                                            ...
                                            <input type="text" name="ph_number" class="line-input" placeholder="Your phone number" required="required">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6 has-input-bl">
                                            <img src="img/icons/user_light_active.svg">
                                            <input type="text" name="l_name" class="line-input" placeholder="Last Name" required="required">
                                        </div>
                                        ...
                                        <div class="col-3 has-input-bl mrt13">
                                            ...
                                            <select class="line-select v-hett" name="gender">
                                             <option  selected class="ab">Gender</option>
                                              <option>Male</option>
