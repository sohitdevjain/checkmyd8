<table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                         <a href="<?php echo site_url('AdminManager/delete/').$test['id'];?>/guid" class="delete"><i class="fa fa-trash fa-lg" aria-hidden="true"></i></a>
...
<h4 class="modal-title">Edit Guid</h4>
</div>
...
$.ajax({
type: 'POST',
url: '<?php echo site_url('AdminManager/editguid')?>',
data:{id: id},
dataType: "json",
