<table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                         <a href="<?php echo site_url('AdminManager/delete/').$test['id'];?>/howitwork" class="delete"><i class="fa fa-trash fa-lg" aria-hidden="true"></i></a>
...
$.ajax({
type: 'POST',
url: '<?php echo site_url('AdminManager/edithowwork')?>',
data:{id: id},
dataType: "json",
